...
<div class="page-header d-flex justify-content-between align-items-start mb-4">
  <div>
    <h1><i class="bi bi-clock me-2"></i>Nuevo Horario</h1>
    <p class="page-subtitle">Definir un bloque horario para grupos</p>
  </div>
...
<div class="panel-cup" style="max-width:760px">
  <div class="panel-cup-body">
    <form action="{{ route('horarios.store') }}" method="POST">
      @csrf
      @include('horarios._form', ['horario' => null])
      <hr>
      <div class="d-flex gap-2 justify-content-end">
        <a href="{{ route('horarios.index') }}" class="btn btn-outline-secondary">Cancelar</a>
        <button type="submit" class="btn btn-cup-primary"><i class="bi bi-check-circle me-1"></i> Guardar Horario</button>
      </div>
    </form>
  </div>
</div>
